...
const About = () => {
  return (
    <div
      ...
      data-aos-delay="300"
      id="about"
      className="flex flex-col mt-4 pt-20 justify-evenly items-center lg:flex-row w-full"
    >
      <div className="about-text w-full  space-y-5 p-4">
        ...
        <p className="leading-8 whitespace-normal text-left">
          ...
          something magical happens, I binge watch comedy sitcoms and solve
          crimes lol.
        </p>

        <button className="rounded shadow hover:bg-white hover:text-red-800  bg-cyan-300 text-amber-900 p-4 font-semibold">
          <a href="https://drive.google.com/file/d/1WLhnDivt2eGnhERRYtjJtqJ1n8vEs_2s/view?usp=sharing">
            Download Resume
          </a>
        </button>
      </div>

      <div className="tech-stacks  flex flex-col items-center p-8 justify-center">
        <h3 className="py-4 my-4 px-2 font-bold text-2xl text-center">
          Technologies I&apos;ve worked with and work with...
        </h3>
        <div className="flex p-8 flex-col space-y-6 ">
          <div className="flex gap-3 m-auto md:gap-8 md:space-x-20">
