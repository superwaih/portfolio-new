    ...
    >
        ...
        <div className="m-auto w-[90%] z-50 flex justify-between items-center">
          ...
          <div className="navlinks md:w-2/5 lg:w-2/4 md:flex hidden lg:block">
            ...
            <a href="#work-experience" className="p-4">
              Experience
            </a>
            <a href="#contact" className="hidden lg:inline-block p-4">
              Contacts
            </a>
          </div>
          ...
          <div className="toggle-theme ">
            ...
            >
              {theme === "dark" ? (
                <BsFillSunFill className="hover:animate-spin" />
              ) : (
                <BsMoonFill className="hover:animate-spin" />
              )}
            </button>
          </div>
