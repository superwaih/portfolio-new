...
const Projects = () => {
  ...
  return (
    <div id='projects' className='p-8 w-full md:p-10 space-x-5 overflow-hidden space-y-10 mb-5' >
      <h3 className='text-center font-bold text-2xl md:text-5xl'>RECENT PROJECTS </h3>
      <div className="cards grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 xl:gap-20 gap-16 gap-x-12">
