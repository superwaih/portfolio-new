...
const Projects = () => {
  ...
  return (
    ...
    data-aos='fade-up'
     ...
     data-aos-delay='300'
    id='projects' className='p-8 w-full md:p-10 space-x-5 overflow-hidden space-y-10 mb-5' >
      ...
      className="cards grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 xl:gap-20 gap-16 gap-x-12">
