...
const ProjectCard = ({project_image, projectname, projectsummary, stacks_used, live_url, repo_url}) => {
  return (
    ...
    <div className="project-card justify-center bg-black text-white  card items-center h-[39rem] lg:h-[35rem] w-full md:w-[400px]    rounded transform hover:scale-105 duration-500 shadow dark:bg-DarkModeElement">
