...
const ProjectCard = ({project_image, projectname, projectsummary, stacks_used, live_url, repo_url}) => {
  return (
    ...
    <div className="project-card gap-4 h-[630px] bg-black text-white  card items-center flex flex-col w-full max-w-[400px]    rounded-[1.2rem] transform hover:scale-105 duration-500 shadow dark:bg-DarkModeElement">
    ...
    <div className="project-details flex flex-col justify-between p-5 h-full w-full ">
      ...
      <div className="button flex font-bold gap-2 justify-between">
